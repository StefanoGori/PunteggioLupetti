...
function InserimentoModificatore() {
  ...
  const handleclick = async () => {
    const payload = { Tipo: Tipo, Punteggio: parseInt(-Punteggio) };
    ...
    <div className="flex h-full bg-gray-100">
      ...
      <div class="flex items-center gap-4">
        <input
          ...
          id="tipo"
          class="p-2 rounded-md border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 flex-grow"
        ...
        <input
          ...
          id="punteggio"
          class="p-2 rounded-md border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          onChange={(e) => setPunteggio(e.target.value)}
        />
        <button
          class="py-2 px-4 bg-blue-500 text-white rounded-md shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          onClick={handleclick}
        >
          Aggiungi
        </button>
...
export default InserimentoModificatore;
